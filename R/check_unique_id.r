...
#'
#' For a user to create a new row observation, the ID for the unique ID column must not already be used.
#'  Function checks user requested unique ID against what's already in the DB
#'
