...
#'    Note: function should only be called once when setting up a table to track within the db
#'    If you need to remove tables, these functions can be helpful:
...
#'
#' @return NULL; and cat statements to the console reporting success or failure
#' @export
#'

create_new_db_tbls <- function(db_conn_pool, db_tbl){

  db_tbl_name <- rlang::as_name(enquo(db_tbl))
